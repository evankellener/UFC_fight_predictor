...
2. Swapping differential and rolling stats
...
def swap_fighter_data(row):
    ...
    # Swap Elo changes
    swapped['precomp_elo_change_3'] = row['opp_precomp_elo_change_3']
    swapped['opp_precomp_elo_change_3'] = row['precomp_elo_change_3']
    swapped['precomp_elo_change_5'] = row['opp_precomp_elo_change_5']
    swapped['opp_precomp_elo_change_5'] = row['precomp_elo_change_5']
    
    swapped['precomp_strike_elo_change_3'] = row['opp_precomp_strike_elo_change_3']
    swapped['opp_precomp_strike_elo_change_3'] = row['precomp_strike_elo_change_3']
    swapped['precomp_strike_elo_change_5'] = row['opp_precomp_strike_elo_change_5']
    swapped['opp_precomp_strike_elo_change_5'] = row['precomp_strike_elo_change_5']
