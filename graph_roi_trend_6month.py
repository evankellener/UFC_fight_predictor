"""
Graph ROI Trend Over Time - 6 Month Test Period
Visualize per-event ROI for most recent 6 months
"""
import pandas as pd
import numpy as np
...
print("="*80)
print("ROI TREND ANALYSIS - Recent 6 Months")
print("="*80)
print()

# Load the 6-month test results
results_file = 'data/tmp/roi_recent_6_month_test.csv'
...
fig.suptitle('ROI Trend Analysis - Recent 6 Months (More Recent Data)', fontsize=16, fontweight='bold')
...
# Plot 4: Rolling 3-event ROI (smaller window for 6 months)
ax4 = axes[1, 1]
window_size = 3
...
plt.tight_layout()
plt.savefig('roi_trend_analysis_6month.png', dpi=150, bbox_inches='tight')
print("="*80)
print("VISUALIZATION SAVED")
print("="*80)
print("✅ Chart saved: roi_trend_analysis_6month.png")
print()

# Additional analysis: First half vs Second half
if len(event_stats) >= 6:
    ...
    print("="*80)
    print("FIRST HALF vs SECOND HALF (of 6-month period)")
    print("="*80)
    ...
    if second_half_roi < first_half_roi:
        print("📉 ROI is LOWER in second half")
    else:
        print("📈 ROI is HIGHER in second half")
    print()
