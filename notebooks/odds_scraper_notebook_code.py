# Copy this entire code block into the empty cell after "## Odds Scrapper"
...
# Make the processed data available for the rest of the notebook
# You can now use df_with_odds in subsequent cells
